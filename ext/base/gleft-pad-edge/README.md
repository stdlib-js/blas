...
#### gleftPadEdge( N, k, x, strideX, y, strideY )
...
#### gleftPadEdge.ndarray( N, k, x, strideX, offsetX, y, strideY, offsetY )
...
gleftPadEdge.ndarray( 3, 2, x, 2, 1, y, -1, y.length-1 );
// y => [ 0.0, 0.0, 6.0, 4.0, 2.0, 2.0, 2.0 ]
```
