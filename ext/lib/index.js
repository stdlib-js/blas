...
*/
setReadOnly( ns, 'cuany', require( './../../ext/cuany' ) );
...
*/
setReadOnly( ns, 'cuevery', require( './../../ext/cuevery' ) );
...
*/
setReadOnly( ns, 'indexOfFalsy', require( './../../ext/index-of-falsy' ) );
...
*/
setReadOnly( ns, 'indexOfNotEqual', require( './../../ext/index-of-not-equal' ) );
...
*/
setReadOnly( ns, 'lastIndexOfFalsy', require( './../../ext/last-index-of-falsy' ) );
...
*/
setReadOnly( ns, 'lastIndexOfTruthy', require( './../../ext/last-index-of-truthy' ) );
...
*/
setReadOnly( ns, 'sort', require( './../../ext/sort' ) );
