...
> Cumulatively test whether at least one element along one or more [ndarray][@stdlib/ndarray/ctor] dimensions is truthy.
...
Cumulatively tests whether at least one element along one or more [ndarray][@stdlib/ndarray/ctor] dimensions is truthy.
...
// returns <ndarray>[ [ false, false ], [ true, false ] ]
...
#### cuany.assign( x, out\[, options] )

Cumulatively tests whether at least one element along one or more [ndarray][@stdlib/ndarray/ctor] dimensions is truthy and assigns results to a provided output [ndarray][@stdlib/ndarray/ctor].
